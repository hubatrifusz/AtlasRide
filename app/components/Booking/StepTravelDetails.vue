...
function initializeInputData() {
  if (bookingStore.form) {
    ...
    departureDate.value = bookingStore.form?.departureDateTime
    ...
    if (bookingStore.form.returnInfo.isReturn) {
      returnDate.value = bookingStore.form?.returnInfo.returnDateTime
        .date as CalendarDate
      returnTime.value = bookingStore.form?.returnInfo.returnDateTime
        .time as Time
    }
  }
}
...
function changeLocationType(type: 'destination' | 'departure') {
  if (type === 'departure') {
    ...
    bookingStore.airportInputCount += state.destinationLocation.isAirport
      ? 1
      : -1
  }
}
  ...
  <div class="w-full max-w-4xl mx-auto">
    ...
    <div class="text-center mb-10">
      ...
      <p class="text-text-secondary">
        Adja meg az indulás és érkezés helyét, valamint az utazás időpontját
      </p>
    </div>
    ...
    <UForm
        ...
        <div v-if="!state.departureLocation.isAirport" class="space-y-4 mt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <UFormField name="departureLocation.zipCode" class="sm:col-span-1">
              ...
              <UInput
                v-model="state.departureLocation.zipCode"
                size="lg"
                placeholder="1234"
                class="w-full" />
            </UFormField>
            ...
            <UFormField name="departureLocation.city" class="sm:col-span-2">
              ...
              <UInput
                v-model="state.departureLocation.city"
                size="lg"
          ...
          <div class="flex gap-4">
            <UFormField name="departureLocation.street" class="flex-1">
              ...
              <UInput
                v-model="state.departureLocation.street"
                size="lg"
      ...
      <fieldset
        ...
        <div v-if="!state.destinationLocation.isAirport" class="space-y-4 mt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <UFormField
              name="destinationLocation.zipCode"
              class="sm:col-span-1">
              <template #label>
                <div class="flex items-center gap-2 text-text-primary mb-2">
                  <UIcon name="i-lucide-hash" class="text-accent-400" />
              ...
              <UInput
                v-model="state.destinationLocation.zipCode"
                size="lg"
                placeholder="1234"
                class="w-full" />
            </UFormField>
            ...
            <UFormField name="destinationLocation.city" class="sm:col-span-2">
              ...
              <UInput
                v-model="state.destinationLocation.city"
                size="lg"
                placeholder="Település neve*"
                class="w-full" />
            </UFormField>
          ...
          <div class="flex gap-4">
            <UFormField name="destinationLocation.street" class="flex-1">
              ...
              <UInput
                v-model="state.destinationLocation.street"
                size="lg"
                placeholder="Példa utca 12."
                class="w-full" />
            </UFormField>
                ...
                <UButton
                  ...
                  {{
                    departureDateTime.date
                      ? departureDateTime.date.toString().replaceAll('-', '. ')
                      : 'Válasszon dátumot'
                  }}
                </UButton>
                <template #content>
              ...
              <UFormField>
                ...
                <UPopover v-model:open="isReturnCalendarOpen">
                  <UButton
                    ...
                    {{
                      returnDate
                        ? returnDate.toString().replaceAll('-', '. ')
                        : 'Válasszon dátumot'
                    }}
                  </UButton>
                  <template #content>
