  ...
  <div class="w-full max-w-2xl mx-auto">
    ...
    <div class="text-center mb-10">
      ...
      <p class="text-text-secondary">
        Adja meg a járatszámokat a pontos fogadáshoz
      </p>
    </div>
      ...
      <fieldset
        ...
        <div class="space-y-4">
          <UFormField name="outboundFlightNumber">
            ...
            <UInput
              v-model="flightData.outboundFlightNumber"
              size="lg"
              placeholder="pl. FR1234, LH5678"
              class="w-full" />
          </UFormField>
        </div>
      </fieldset>
      ...
      <fieldset
        ...
        <div class="space-y-4">
          <UFormField name="returnFlightNumber">
            ...
            <UInput
              v-model="flightData.returnFlightNumber"
              size="lg"
              placeholder="pl. FR5678, LH1234"
              class="w-full" />
          </UFormField>
        </div>
      </fieldset>
    ...
    <!-- Privacy Info Banner -->
    <div
      class="mt-8 bg-accent-700/20 border border-accent-500/30 rounded-xl p-4">
      <div class="flex items-start gap-3">
        <UIcon
          name="i-lucide-shield-check"
          class="text-accent-400 mt-0.5 shrink-0" />
        <p class="text-text-secondary text-sm">
          A járatinformációkat csak a megfelelő időpontú fogadás és maximális
          kényelem érdekében használjuk fel. Járatkésés esetén figyeljük a járat
          aktuális státuszát.
        </p>
      </div>
    </div>
